import{E as _,o as g}from"./VertexArrayObject-CscjxoEh.js";import{x as j,s as F}from"./FramebufferObject-C9hNzl_h.js";import{r as c}from"./ProgramTemplate-BMKJ5eWv.js";import{e as O,a as P}from"./ProgramTemplate-BMKJ5eWv.js";import{da as A}from"./index-BlXvYXyk.js";import{t as p}from"./NestedMap-GuqgquCN.js";import"./memoryEstimations-BaCoozKz.js";class ${constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function x(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
